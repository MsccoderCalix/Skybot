...
module.exports = {
   ...
   alias: ['kick','remover'],
   category: 'group',
   desc: 'Eliminar integrante del grupo',
   use: '<numero de telefono>\nEjemplo: /kick 5058444xxxx',
   async exec(msg, sock, args) {
    try {
      ...
      await sock.groupParticipantsUpdate(
        ...
        //await sock.sendMessage(msg.sender, { text: "Introduce el número o responde al mensaje!" }, { quoted: message })
      }
    } catch (error) {
